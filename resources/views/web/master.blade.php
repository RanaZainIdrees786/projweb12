    ...
    <div class="container-fluid fixed-top">
        <div class="container px-0">
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                <a href="{{route('fruitable-index')}}" class="navbar-brand">
                ...
                <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                    <div class="navbar-nav mx-auto">
                        <a href="{{route('fruitable-index')}}" class="nav-item nav-link active">Home</a>
                        <a href="{{route('fruitable-shop')}}" class="nav-item nav-link">Shop</a>
                        <a href="{{route('fruitable-cart')}}" class="nav-item nav-link">Cart</a>
                        <a href="{{route('fruitable-checkout')}}" class="nav-item nav-link">Checkout</a>
                        {{-- <a href="{{}}" class="nav-item nav-link">Shop Detail</a> --}}
                        {{-- <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                            <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                <a href="{{route('fruitable-cart')}}" class="dropdown-item">Cart</a>
                                <a href="{{route('fruitable-checkout')}}" class="dropdown-item">Checkout</a>
                                <a href="testimonial.html" class="dropdown-item">Testimonial</a>
                                <a href="404.html" class="dropdown-item">404 Page</a>
                            </div>
                        </div> --}}
                        <a href="{{route('fruitable-contact')}}" class="nav-item nav-link">Contact</a>
                    </div>
